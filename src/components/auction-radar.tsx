...
export function AuctionRadar() {
  ...
  return <main className="page-shell inner-page auction-radar-page">
    <header className="terminal-page-heading"><div><span className="section-kicker">AUCTION RADAR</span><h1>全球球星卡拍卖雷达</h1><p>追踪国内外主要拍卖活动、竞价热度和市场关注变化。</p></div><div className="updated-at"><span>数据状态</span><DemoDataBadge /></div></header>
    ...
    <p className="source-note">Heat Score 仅代表当前拍卖关注与竞价活跃程度，不代表投资价值或价格涨跌预测。演示记录不会被当作实时竞价；接入授权源后才展示可追溯原始链接。</p>
  </main>;
}
